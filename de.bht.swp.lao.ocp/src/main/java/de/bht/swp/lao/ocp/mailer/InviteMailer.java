...
public class InviteMailer extends AbstractMailer {
     ...
     */
    public InviteMailer(String serverHost, String contextPath,
            final User invitedUser, final Whiteboard whiteboard) {
        ...
        s.append("User: " + invitedUser.getEmail() + "<br />" + "Password: "
                + invitedUser.getPassword());
        s.append("<br /><br />" + "With Regards,<br /><br />"
                + "[l]ook [a]head [o]nline");

        this.setSubject("[lao] Invitation to Whiteboard "
                + whiteboard.getName());
