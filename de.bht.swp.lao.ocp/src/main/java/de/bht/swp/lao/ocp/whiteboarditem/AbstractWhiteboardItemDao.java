 ...
 * 
 */
public abstract class AbstractWhiteboardItemDao<T extends WhiteboardItem>
        implements IWhiteboardItemDao<T> {
     ...
     * 
     * @see
     * de.bht.swp.lao.ocp.whiteboarditem.IWhiteboardItemDao#findById(java.lang
     * .Long)
     */
    ...
    public List<T> findAll() {
        try {
            return em.createQuery("from " + getTablename() + " w")
                    .getResultList();
        } catch (Exception e) {
            getLogger().error("Save failed:", e);
            throw new OCPDBException("Save failed:", e);
     ...
     * 
     * @see
     * de.bht.swp.lao.ocp.whiteboarditem.IWhiteboardItemDao#save(de.bht.swp.lao
     * .ocp.whiteboarditem.WhiteboardItem)
     */
    @Override
    @Transactional
     ...
     * 
     * @see
     * de.bht.swp.lao.ocp.whiteboarditem.IWhiteboardItemDao#delete(de.bht.swp.
     ...
     * 
     * @see
     * de.bht.swp.lao.ocp.whiteboarditem.IWhiteboardItemDao#findAllbyWhiteboardId
     * (java.lang.Long)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * 
     * @see
     * de.bht.swp.lao.ocp.whiteboarditem.IWhiteboardItemDao#findByAttribute(java
    ...
    public T findByAttribute(String key, Object value) {
        try {
            return (T) em.createQuery("from " + getTablename() + " w where w."
                    + key + "='" + value + "'");
        } catch (Exception e) {
     ...
     * (non-Javadoc)
     * 
     * @see de.bht.swp.lao.ocp.whiteboarditem.IWhiteboardItemDao#
     * getHighestOrderIndexByWhiteboardId(java.lang.Long)
     */
    @Override
    public Integer getHighestOrderIndexByWhiteboardId(Long id) {
        ...
        try {
            index = (Integer) em
                    .createQuery(
                            "SELECT MAX(w.orderIndex) from WhiteboardItem w WHERE w.whiteboard.id=?1")
                    .setParameter(1, id).getSingleResult();
            getLogger().debug("" + index);
        } catch (Exception e) {
            throw new OCPDBException(
                    "getHighestOrderIndexByWhiteboardId failed", e);
        }
