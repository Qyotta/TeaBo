...
public class AttachmentController {
    ...
    public void uploadFile(@RequestParam("data") MultipartFile data,
        ...
        try {
            ...
            if (!mimeTypes.contains(metadata.get(HttpHeaders.CONTENT_TYPE))) {
                LOGGER.info("Not allowed Mime-Type: "
    ...
    /**
     * Handles download requests. Returns the requested file via the output
     * stream of response. Throws an exception if requested file is not found.
     * 
     * @param id
